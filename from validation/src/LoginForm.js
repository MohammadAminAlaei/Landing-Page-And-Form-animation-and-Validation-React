...
class LoginForm extends React.Component {
    ...
    handleSingin = (e) => {
        ...
        console.log(storage)
        // console.log(this.state.passwordSignin)
                ...
                <div className="container" id="container" ref={this.container}>
                    ...
                    <div className="form-container sign-in-container">
                        <form onSubmit={this.handleSingin}>
                            ...
                            <input required type="email" placeholder="Email" value={emailSignin} name='emailSignin'
                                   onChange={this.signinChange}/>
                            <input required type="password" placeholder="Password" value={passwordSignin}
                                   name='passwordSignin'
                                   onChange={this.signinChange}/>
